...
import cn.test.util.ActiveMQUtil;
...
public class TestConsumer {
    ...
    //这次消费的消息名称
    private static final String topicName="queue_demo";

    //消费者有可能是多个，为了区分不同的消费者，为其创建随机名称
    private static final String consumerName="consumerdemo-" + RandomUtil.randomString(5);
